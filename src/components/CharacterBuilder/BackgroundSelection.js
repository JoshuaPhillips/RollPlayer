...
const BackgroundSelection = () => {
  return (
    <section>
      <h2>Step Four: Describe your character.</h2>
      <p>
        Once you know the basic game aspects of your character, it's time to flesh them out as a person. Your character
        needs a name. Spend a few minutes thinking about what they look like and how they behave in general terms.
      </p>
      <p>
      ...
      <p>
        ...
        below, and might be willing to work with you to craft a background that's a more precise fit for your character
        concept.
      </p>
      <p>
